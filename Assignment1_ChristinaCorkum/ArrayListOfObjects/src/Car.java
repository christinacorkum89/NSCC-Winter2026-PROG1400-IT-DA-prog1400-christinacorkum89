public class Car {
    ...
    public Car(String carsMake, String carsModel, String carsColor,
               int year, double priceBeforeTax) {
        this.carsMake = carsMake;
        this.carsModel = carsModel;
        this.carsColor = carsColor;
        this.year = year;
        this.priceBeforeTax = priceBeforeTax;
//        this.listPrice = this.priceBeforeTax *1.14 + 500;
        this.listPrice = this.priceBeforeTax + this.priceBeforeTax * 0.14 + 500;
    }
    ...
    public String toString(){
        String report = this.report2() + String.format("\nPrice Before Tax: $%.2f -\t" +
                "List Price: $%.2f",this.priceBeforeTax,this.listPrice);
        return report;
    }
